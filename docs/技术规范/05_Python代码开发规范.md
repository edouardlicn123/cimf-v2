...
nodes/                         # 节点主应用
├── models.py                  # 公共模型（NodeType, Node）
├── services/                  # 公共服务
├── views.py                   # 通用视图
└── urls.py                    # 路由配置

nodes/customer/               # 海外客户子应用
...
| 文档 | 关系 |
|------|------|
| **02_Node模块技术规范.md** | 本规范提供通用代码规范，该文档提供节点业务模块的具体实现指引 |
| **04_模板开发规范.md** | 本规范定义后端代码规范，该文档定义 Jinja2 模板语法，前者渲染数据供后者使用 |
| **03_省市县联动字段技术规范.md** | 该文档中的省市区字段实现应遵循本规范的 Model 定义规范 |
...
路径：/home/edo/cimf-v2/nodes/services/customer_service.py
================================================================================
...
class NodeViewsTestCase(TestCase):
    ...
    def test_node_delete_nonexistent_node(self):
        ...
        response = self.client.get('/nodes/customer/delete/99999/')
...
# 输出：Migrations for 'nodes': nodes/migrations/0004_add_customer_fields.py

# 错误示例：无意义的名称
./venv/bin/python manage.py makemigrations
# 输出：nodes/migrations/0004_auto_20240101_0000.py  # 难以理解
```
...
def my_list(request, node_type_slug: str):
    ...
    return render(request, 'nodes/my/list.html', {
        'node_type': node_type,
        'items': items,
        'search': search,
    })
...
def my_create(request, node_type_slug: str):
    ...
    return render(request, 'nodes/my/edit.html', {
        'node_type': node_type,
        'item': None,
    })
...
| 文档 | 说明 |
|------|------|
| **02_Node模块技术规范.md** | Node 节点类型系统的实现指南 |
| **04_模板开发规范.md** | Jinja2 模板语法规范 |
| **03_省市县联动字段技术规范.md** | 省市区三级联动字段设计 |
