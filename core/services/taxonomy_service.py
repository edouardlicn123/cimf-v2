...
DEFAULT_TAXONOMIES = [
    ...
    {
        "name": "人员关系",
        "slug": "resident_relation",
        "description": "居民与其他人员关系",
        "items": ["户主", "配偶", "子女", "父母", "兄弟姐妹", "祖父母", "外祖父母", "租户", "其他"]
    },
    {
        "name": "所属网格",
        "slug": "grid",
    ...
    },
    {
        ...
        "slug": "resident_type",
        "description": "居民人员类型",
        "items": ["户籍人口", "常住人口", "流动人口", "暂住人口"]
    },
    {
        "name": "重点类别",
        "slug": "key_category",
        "description": "重点人员类别",
        "items": ["独居老人", "低保户", "残疾人", "重症患者", "刑满释放人员", "社区矫正对象", "涉毒人员", "其他"]
    },
    {
        "name": "民族",
        "slug": "nation",
        "description": "中国民族",
        "items": ["汉族", "蒙古族", "回族", "藏族", "维吾尔族", "苗族", "彝族", "壮族", "布依族", "朝鲜族", "满族", "侗族", "瑶族", "白族", "土家族", "哈尼族", "哈萨克族", "傣族", "黎族", "傈僳族", "佤族", "畲族", "高山族", "拉祜族", "水族", "东乡族", "纳西族", "景颇族", "柯尔克孜族", "土族", "达斡尔族", "仫佬族", "羌族", "布朗族", "撒拉族", "毛南族", "仡佬族", "锡伯族", "阿昌族", "普米族", "塔吉克族", "怒族", "乌孜别克族", "俄罗斯族", "鄂温克族", "德昂族", "保安族", "裕固族", "京族", "塔塔尔族", "独龙族", "鄂伦春族", "赫哲族", "门巴族", "珞巴族", "基诺族", "其他"]
    },
    {
        "name": "政治面貌",
        "slug": "political_status",
        "description": "政治面貌",
    ...
    },
    {
        ...
        "slug": "health_status",
        "description": "健康状况",
        "items": ["健康", "良好", "一般", "较差", "残疾", "疾病", "慢性病"]
    },
    {
        "name": "文化程度",
        "slug": "education_level",
        "description": "文化程度",
        "items": ["研究生", "本科", "大专", "高中", "初中", "小学", "文盲"]
    },
]
