...
| [Python代码开发规范](./技术规范/05_Python代码开发规范.md) | Django 后端代码开发规范，包括文件头注释、导入规范、命名规范、Model/Service/View 规范、API 设计、测试、迁移、定时任务、**字段空值处理规范**等 |
| [02_模块技术规范](./技术规范/02_模块技术规范.md) | 模块的模型，服务、视图、权限控制规范 |
